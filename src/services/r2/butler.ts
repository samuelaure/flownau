...
import { getFileHash, formatSize } from './lib/utils';
import { compressVideo, compressAudio } from './lib/ffmpeg';
import { uploadToR2, deleteR2Object } from './lib/sync';
      ...
      if (!projectConfig) {
        ...
        const setupAnswers = await inquirer.prompt([
          ...
          },
          {
            ...
            when: (answers: any) => answers.shortCodeOption === 'Custom',
