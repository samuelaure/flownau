...
-- CreateIndex
CREATE UNIQUE INDEX "Project_userId_shortCode_key" ON "Project"("userId", "shortCode");
...
-- AddForeignKey
ALTER TABLE "Job" ADD CONSTRAINT "Job_renderId_fkey" FOREIGN KEY ("renderId") REFERENCES "Render"("id") ON DELETE CASCADE ON UPDATE CASCADE;
